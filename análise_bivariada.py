...
if __name__ == "__main__":
    ...
    try:
        ...
        # 2. CARREGAR E JUNTAR OS DATAFRAMES
        ...
        # Juntar o resultado com df_non_linear
        ...
        # Exemplo: MEAN_RR (Time Domain) vs. VLF (Frequency Domain)
        ...
        # Exemplo 2: LF_HF (Frequency Domain) vs. ApEn (Non-Linear)
